          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative shrink-0">
              <div 
                ...
                className="w-20 h-20 sm:w-22 sm:h-22 rounded-2xl bg-[#181D28] border-2 border-purple-500/40 hover:border-purple-400 flex items-center justify-center cursor-pointer transition-all shadow-md relative group overflow-hidden"
