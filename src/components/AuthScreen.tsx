        ...
        <div className="p-8 space-y-6">
          <AnimatePresence mode="wait">
            ...
            {step === 'welcome' && (
              ...
              >
                {/* App Brand Icon */}
                <div className="mx-auto w-16 h-16 rounded-2xl bg-blue-600 flex items-center justify-center shadow-[0_0_25px_rgba(37,99,235,0.4)]">
                ...
                {showIframeWarning && (
                  <div className="p-3.5 bg-amber-950/20 border border-amber-900/50 rounded-2xl text-left space-y-1.5 shadow-inner">
                    ...
                    <ul className="list-disc pl-4 text-[11px] text-gray-300 space-y-1.5 leading-relaxed">
                      <li>
